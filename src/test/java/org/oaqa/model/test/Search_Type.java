...
public class Search_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.test.Search");
  ...
  public String getQuery(int addr) {
      ...
      jcas.throwFeatMissing("query", "org.oaqa.model.test.Search");
  ...
  public int getHitList(int addr) {
      ...
      jcas.throwFeatMissing("hitList", "org.oaqa.model.test.Search");
  ...
  public int getAbstractQuery(int addr) {
      ...
      jcas.throwFeatMissing("abstractQuery", "org.oaqa.model.test.Search");
  ...
  public String getSearchId(int addr) {
      ...
      jcas.throwFeatMissing("searchId", "org.oaqa.model.test.Search");
  ...
  public Search_Type(JCas jcas, Type casType) {
    ...
    casFeat_abstractQuery = jcas.getRequiredFeatureDE(casType, "abstractQuery", "org.oaqa.model.test.AbstractQuery", featOkTst);
