...
public class AbstractQuery_Type extends OAQATop_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.test.AbstractQuery");
  ...
  public int getConcepts(int addr) {
      ...
      jcas.throwFeatMissing("concepts", "org.oaqa.model.test.AbstractQuery");
