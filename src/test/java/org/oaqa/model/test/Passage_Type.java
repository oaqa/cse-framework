...
public class Passage_Type extends SearchResult_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.test.Passage");
  ...
  public String getTitle(int addr) {
      ...
      jcas.throwFeatMissing("title", "org.oaqa.model.test.Passage");
  ...
  public String getDocId(int addr) {
      ...
      jcas.throwFeatMissing("docId", "org.oaqa.model.test.Passage");
  ...
  public int getBegin(int addr) {
      ...
      jcas.throwFeatMissing("begin", "org.oaqa.model.test.Passage");
  ...
  public int getEnd(int addr) {
      ...
      jcas.throwFeatMissing("end", "org.oaqa.model.test.Passage");
  ...
  public String getAspects(int addr) {
      ...
      jcas.throwFeatMissing("aspects", "org.oaqa.model.test.Passage");
