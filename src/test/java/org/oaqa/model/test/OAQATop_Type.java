...
public class OAQATop_Type extends TOP_Type {
  ...
  /** @generated 
     @modifiable */
  public final static boolean featOkTst = JCasRegistry.getFeatOkTst("org.oaqa.model.test.OAQATop");
  ...
  public String getComponentId(int addr) {
      ...
      jcas.throwFeatMissing("componentId", "org.oaqa.model.test.OAQATop");
  ...
  public float getProbability(int addr) {
      ...
      jcas.throwFeatMissing("probability", "org.oaqa.model.test.OAQATop");
